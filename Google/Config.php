...
class WPTC_Google_Config
{
  ...
  /**
   * Create a new WPTC_Google_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'WPTC_Google_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'WPTC_Google_Cache_File',
      'logger_class'  => 'WPTC_Google_Logger_Null',
      ...
      'classes' => array(
        'WPTC_Google_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'WPTC_Google_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'WPTC_Google_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'WPTC_Google_Http_Request' => array(
        ...
        'WPTC_Google_Service_Exception' => array(
          'retry_map' => array(
        ...
        'WPTC_Google_IO_Exception' => array(
        ...
        'WPTC_Google_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/WPTC_Google_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see WPTC_Google_Auth_LoginTicket) after sign
