...
class Wptc_Settings extends Wptc_Settings_Init {
	...
	public $plugin_data;
	public $tabs;
	const JQUERY_UI_JS_PATH = '/treeView/jquery-ui.custom.js';
	const FANCY_TREE_JS_PATH = '/treeView/jquery.fancytree.js';
	const JQUERY_FILE_TREE_CSS_PATH = '/JQueryFileTree/jqueryFileTree.css';
	const FANCY_TREE_CSS_PATH = '/treeView/skin/ui.fancytree.css';
	const SETTINGS_JS = '/Classes/Settings/scripts.js';
	private $server_ips;
	...
	private function include_header_files(){
		wp_enqueue_script('wptc-settings-js', plugins_url() . '/' . WPTC_TC_PLUGIN_NAME . self::SETTINGS_JS, array(), WPTC_VERSION);
		wp_enqueue_script('wptc-jquery-ui-custom-js', plugins_url() . '/' . WPTC_TC_PLUGIN_NAME . self::JQUERY_UI_JS_PATH, array(), WPTC_VERSION);
		wp_enqueue_script('wptc-fancytree-js', plugins_url() . '/' . WPTC_TC_PLUGIN_NAME . self::FANCY_TREE_JS_PATH, array(), WPTC_VERSION);
		wp_enqueue_style('wptc-jquery-fileTree-css', plugins_url() . '/' . WPTC_TC_PLUGIN_NAME . self::JQUERY_FILE_TREE_CSS_PATH, array(), WPTC_VERSION);
		wp_enqueue_style('wptc-fancytree-css', plugins_url() . '/' . WPTC_TC_PLUGIN_NAME . self::FANCY_TREE_CSS_PATH, array(), WPTC_VERSION);
	}
	...
	public function auto_whitelist_ips(){
		...
		if (!empty($plugins['wordfence/wordfence.php'])) {
			...
			dark_debug($wordfence_whitelist_keys, '--------$wordfence_whitelist_keys--------');
